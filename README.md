...
| [`docs/issue-81/`](docs/issue-81/) | Issue #81 frozen, outcome-free context-construction experiment protocol, task/source manifests, and deterministic preflight validator |
